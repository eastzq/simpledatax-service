...
public final class CommunicationTool {
    ...
    public static class Stringify {
        ...
        public static String getSnapshot(final Communication communication) {
            ...
            sb.append(communication.getLongCounter(WAIT_WRITER_TIME));
            sb.append(" | ");
            sb.append(" All Task WaitReaderTime ");
            sb.append(communication.getLongCounter(WAIT_READER_TIME));
            sb.append(" | ");
            if (communication.getLongCounter(CommunicationTool.TRANSFORMER_USED_TIME) > 0
                ...
                sb.append(communication.getLongCounter(CommunicationTool.TRANSFORMER_USED_TIME));
                sb.append(" | ");
            }
