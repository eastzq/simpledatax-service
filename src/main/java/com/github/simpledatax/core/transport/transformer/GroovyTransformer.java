...
public class GroovyTransformer extends Transformer {
    ...
    private String getGroovyRule(String expression, List<String> extraPackagesStrList) {
        ...
        sb.append("import static com.github.simpledatax.core.transport.transformer.GroovyTransformerStaticUtil.*;");
        sb.append("import com.github.simpledatax.common.element.*;");
        sb.append("import com.github.simpledatax.common.exception.DataXException;");
        sb.append("import com.github.simpledatax.transformer.Transformer;");
