...
public enum FrameworkErrorCode implements ErrorCode {
    ...
    HOOK_LOAD_ERROR("Framework-05", "加载外部Hook出现错误，通常是由于DataX安装引起的"), HOOK_FAIL_ERROR("Framework-06", "执行外部Hook出现错误"),
    ...
    CALL_DATAX_SERVICE_FAILED("Framework-18", "请求 DataX Service 出错."), CALL_REMOTE_FAILED("Framework-19", "远程调用失败。"),
