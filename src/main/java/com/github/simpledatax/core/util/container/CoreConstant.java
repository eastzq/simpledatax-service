...
public class CoreConstant {
    ...
    public static final String DATAX_CORE_CONTAINER_JOB_ISCLEARJOBTEMPFILE = "core.container.job.isClearJobTempFile";

    public static final String DATAX_CORE_CONTAINER_JOB_TEMPFILEPATH = "core.container.job.tempFilePath";
    ...
    public static final String DATAX_CORE_TRANSPORT_CHANNEL_CHANNELNUM = "core.transport.channel.channelNum";
    ...
    public static String DATAX_CONF_PATH = StringUtils.join(new String[] { DATAX_HOME, "conf", "core.json" },
            File.separator);

    public static String DATAX_CONF_LOG_PATH = StringUtils.join(new String[] { DATAX_HOME, "conf", "logback.xml" },
            File.separator);

    public static String DATAX_SECRET_PATH = StringUtils.join(new String[] { DATAX_HOME, "conf", ".secret.properties" },
            File.separator);

    public static String DATAX_PLUGIN_HOME = StringUtils.join(new String[] { DATAX_HOME, "plugin" }, File.separator);

    public static String DATAX_PLUGIN_READER_HOME = StringUtils.join(new String[] { DATAX_HOME, "plugin", "reader" },
            File.separator);

    public static String DATAX_PLUGIN_WRITER_HOME = StringUtils.join(new String[] { DATAX_HOME, "plugin", "writer" },
            File.separator);

    public static String DATAX_BIN_HOME = StringUtils.join(new String[] { DATAX_HOME, "bin" }, File.separator);

    public static String DATAX_JOB_HOME = StringUtils.join(new String[] { DATAX_HOME, "job" }, File.separator);

    public static String DATAX_STORAGE_TRANSFORMER_HOME = StringUtils
            .join(new String[] { DATAX_HOME, "local_storage", "transformer" }, File.separator);

    public static String DATAX_STORAGE_PLUGIN_READ_HOME = StringUtils
            .join(new String[] { DATAX_HOME, "local_storage", "plugin", "reader" }, File.separator);

    public static String DATAX_STORAGE_PLUGIN_WRITER_HOME = StringUtils
            .join(new String[] { DATAX_HOME, "local_storage", "plugin", "writer" }, File.separator);
