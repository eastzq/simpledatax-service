...
public class ResourceUtil {
     ...
     * 
     * @param clazz        jar包中的任一Class对象
     * @param resourceName 资源名称 如a.xml 也可以是a/b.xml classpath下
    ...
    private static void loadRecourceFromJar(String path, String destFolderPath, Class clazz, boolean isOverride)
            throws IOException {
        if (!path.startsWith("/")) {
