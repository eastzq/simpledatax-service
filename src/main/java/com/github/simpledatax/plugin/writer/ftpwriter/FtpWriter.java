...
import com.github.simpledatax.plugin.writer.ftpwriter.util.Constant;
    ...
    public static class Task extends Writer.Task {
        ...
        public void init() {
            ...
            this.suffix = this.writerSliceConfig
                    .getString(com.github.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.SUFFIX);
