...
import com.zq.simpledatax.common.element.ColumnCast;
...
import com.zq.simpledatax.core.job.JobContainer;
import com.zq.simpledatax.core.taskgroup.TaskGroupContainer;
import com.zq.simpledatax.core.util.ConfigParser;
import com.zq.simpledatax.core.util.ConfigurationValidate;
import com.zq.simpledatax.core.util.ExceptionTracker;
...
public class Engine {
	...
	public Map<String, Object> start(Configuration allConf) {
		...
		// 缺省打开perfTrace
		boolean traceEnable = allConf.getBool(CoreConstant.DATAX_CORE_CONTAINER_TRACE_ENABLE, false);
		...
		// 初始化PerfTrace
		PerfTrace perfTrace = PerfTrace.getInstance(true, instanceId, -1, priority, traceEnable);
