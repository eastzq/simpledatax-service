...
public class GroovyTransformer extends Transformer {
    ...
    private String getGroovyRule(String expression, List<String> extraPackagesStrList) {
        ...
        sb.append("import static com.zq.simpledatax.core.transport.transformer.GroovyTransformerStaticUtil.*;");
        sb.append("import com.zq.simpledatax.common.element.*;");
        sb.append("import com.zq.simpledatax.common.exception.DataXException;");
        sb.append("import com.zq.simpledatax.transformer.Transformer;");
