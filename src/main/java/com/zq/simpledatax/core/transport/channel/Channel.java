package com.zq.simpledatax.core.transport.channel;
...
public abstract class Channel {
    ...
    public Channel(final Configuration configuration) {
        ...
        long byteSpeed = configuration.getLong(
                CoreConstant.DATAX_CORE_TRANSPORT_CHANNEL_SPEED_BYTE, -1);
        long recordSpeed = configuration.getLong(
                CoreConstant.DATAX_CORE_TRANSPORT_CHANNEL_SPEED_RECORD, -1);
