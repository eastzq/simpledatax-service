...
package com.zq.simpledatax.core.transport.exchanger;

import java.util.List;

import com.zq.simpledatax.common.element.Record;
import com.zq.simpledatax.common.exception.CommonErrorCode;
...
import com.zq.simpledatax.core.transport.record.TerminateRecord;
		...
		try {
			RecordExchanger.RECORD_CLASS = (Class<? extends Record>) Class
					.forName(configuration.getString(
                            ...
                            "com.zq.simpledatax.core.transport.record.DefaultRecord"));
