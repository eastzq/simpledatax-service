package com.zq.simpledatax.plugin.writer.ftpwriter;
...
import com.zq.simpledatax.common.util.RetryUtil;
import com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredStorageWriterUtil;
import com.zq.simpledatax.plugin.writer.ftpwriter.util.Constant;
import com.zq.simpledatax.plugin.writer.ftpwriter.util.IFtpHelper;
import com.zq.simpledatax.plugin.writer.ftpwriter.util.SftpHelperImpl;
import com.zq.simpledatax.plugin.writer.ftpwriter.util.StandardFtpHelperImpl;
    ...
    public static class Job extends Writer.Job {
        ...
        private void validateParameter() {
            this.writerSliceConfig
                    .getNecessaryValue(
                            com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.FILE_NAME,
        ...
        public void prepare() {
            ...
            String fileName = this.writerSliceConfig
                    .getString(com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.FILE_NAME);
            String writeMode = this.writerSliceConfig
                    .getString(com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.WRITE_MODE);
    ...
    public static class Task extends Writer.Task {
        ...
        public void init() {
            ...
            this.suffix = this.writerSliceConfig
                    .getString(com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.SUFFIX);
