package com.zq.simpledatax.plugin.writer.txtfilewriter;
    ...
    public static class Job extends Writer.Job {
        ...
        public void init() {
            ...
            String dateFormatOld = this.writerSliceConfig
                    .getString(com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.FORMAT);
            String dateFormatNew = this.writerSliceConfig
                    .getString(com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.DATE_FORMAT);
            if (null == dateFormatNew) {
                this.writerSliceConfig
                        .set(com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.DATE_FORMAT,
                                dateFormatOld);
            }
        ...
        public List<Configuration> split(int mandatoryNumber) {
            ...
            for (int i = 0; i < mandatoryNumber; i++) {
                ...
                splitedTaskConfig
                        .set(com.zq.simpledatax.plugin.unstructuredstorage.writer.UnstructuredWriterKey.FILE_NAME,
                                fullFileName);
