package com.zq.simpledatax.plugin.unstructuredstorage.writer;
...
public class UnstructuredStorageWriterUtil {
    ...
    public static void validateParameter(Configuration writerConfiguration) {
        ...
        String compress = writerConfiguration.getString(UnstructuredWriterKey.COMPRESS);
        if (StringUtils.isBlank(compress)) {
            writerConfiguration.set(UnstructuredWriterKey.COMPRESS, null);
        } else {
        ...
        // fileFormat check
        String fileFormat = writerConfiguration.getString(UnstructuredWriterKey.FILE_FORMAT,
    ...
    public static List<Configuration> split(Configuration writerSliceConfig,
        ...
        String filePrefix = writerSliceConfig.getString(UnstructuredWriterKey.FILE_NAME);
    ...
    public static void writeToStream(RecordReceiver lineReceiver,
        ...
        if (StringUtils.isBlank(encoding)) {
            LOG.warn(String.format("您配置的encoding为[%s], 使用默认值[%s]", encoding,
                    UnstructuredWriterConstant.DEFAULT_ENCODING));
            encoding = UnstructuredWriterConstant.DEFAULT_ENCODING;
        }
        String compress = config.getString(UnstructuredWriterKey.COMPRESS);
    ...
    private static void doWriteToStream(RecordReceiver lineReceiver,
        ...
        // 兼容format & dataFormat
        String dateFormat = config.getString(UnstructuredWriterKey.DATE_FORMAT);
        ...
        // warn: default false
        String fileFormat = config.getString(UnstructuredWriterKey.FILE_FORMAT,
                UnstructuredWriterConstant.FILE_FORMAT_TEXT);
