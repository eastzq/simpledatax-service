...
import com.zq.simpledatax.plugin.rdbms.util.RdbmsException;
import com.zq.simpledatax.plugin.rdbms.writer.util.OriginalConfPretreatmentUtil;
import com.zq.simpledatax.plugin.rdbms.writer.util.WriterUtil;
...
public class CommonRdbmsWriter {
    ...
    public static class Job {
        ...
        public void privilegeValid(Configuration originalConfig, DataBaseType dataBaseType) {
            ...
            for (int i = 0, len = connections.size(); i < len; i++) {
                ...
                if (!hasInsertPri) {
                    throw RdbmsException.asInsertPriException(dataBaseType, originalConfig.getString(RdbmsWriterKey.USERNAME), jdbcUrl);
                }
                ...
                if (DBUtil.needCheckDeletePrivilege(originalConfig)) {
                    ...
                    if (!hasDeletePri) {
                        throw RdbmsException.asDeletePriException(dataBaseType, originalConfig.getString(RdbmsWriterKey.USERNAME), jdbcUrl);
                    }
                }
            }
        }
        ...
        public void prepare(Configuration originalConfig) {
            ...
            if (tableNumber == 1) {
                ...
                List<Object> conns = originalConfig.getList(RdbmsWriterConstant.CONN_MARK,
                        Object.class);
                ...
                List<String> preSqls = originalConfig.getList(RdbmsWriterKey.PRE_SQL,
                        String.class);
        ...
        public void post(Configuration originalConfig) {
            ...
            if (tableNumber == 1) {
                ...
                List<String> postSqls = originalConfig.getList(RdbmsWriterKey.POST_SQL,
                        String.class);
    ...
    public static class Task {
        ...
        public void init(Configuration writerSliceConfig) {
            ...
            //ob10的处理
            if (this.jdbcUrl.startsWith(RdbmsWriterConstant.OB10_SPLIT_STRING) && this.dataBaseType == DataBaseType.MySql) {
            ...
            this.batchSize = writerSliceConfig.getInt(RdbmsWriterKey.BATCH_SIZE, RdbmsWriterConstant.DEFAULT_BATCH_SIZE);
            this.batchByteSize = writerSliceConfig.getInt(RdbmsWriterKey.BATCH_BYTE_SIZE, RdbmsWriterConstant.DEFAULT_BATCH_BYTE_SIZE);
            ...
            INSERT_OR_REPLACE_TEMPLATE = writerSliceConfig.getString(RdbmsWriterConstant.INSERT_OR_REPLACE_TEMPLATE_MARK);
        ...
        public void prepare(Configuration writerSliceConfig) {
            ...
            int tableNumber = writerSliceConfig.getInt(
                    RdbmsWriterConstant.TABLE_NUMBER_MARK);
            if (tableNumber != 1) {
                LOG.info("Begin to execute preSqls:[{}]. context info:{}.",
        ...
        public void startWriteWithConnection(RecordReceiver recordReceiver, TaskPluginCollector taskPluginCollector, Connection connection) {
            ...
            // wlin_000 2019-02-1 将StringUtils.join(this.columns, ",") 修改为
                ...
                while ((record = recordReceiver.getFromReader()) != null) {
                    if (record.getColumnNumber() != this.columnNumber) {
                        ...
                        throw DataXException.asDataXException(DBUtilErrorCode.CONF_ERROR, String
                                .format("列配置信息有错误. 因为您配置的任务中，源头读取字段数:%s 与 目的表要写入的字段数:%s 不相等. 请检查您的配置并作出修改.",
        ...
        protected String calcValueHolder(int columnSqltype, int columnIndex, Object value) {
            ...
            case Types.BIT:
                ...
                break;
            default:
                throw DataXException.asDataXException(DBUtilErrorCode.UNSUPPORTED_TYPE, String
                        .format("您的配置文件中的列配置信息有误. 因为DataX 不支持数据库写入这种字段类型. 字段名:[%s], 字段类型:[%d], 字段Java类型:[%s]. 请修改表中该字段的类型或者不同步该字段.",
