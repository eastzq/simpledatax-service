package com.zq.simpledatax.plugin.rdbms.reader;
...
import com.zq.simpledatax.common.element.BytesColumn;
...
import com.zq.simpledatax.plugin.rdbms.reader.util.OriginalConfPretreatmentUtil;
import com.zq.simpledatax.plugin.rdbms.reader.util.PreCheckTask;
import com.zq.simpledatax.plugin.rdbms.reader.util.ReaderSplitUtil;
...
public class CommonRdbmsReader {
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            //ob10的处理
            if (this.jdbcUrl.startsWith(com.zq.simpledatax.plugin.rdbms.writer.RdbmsWriterConstant.OB10_SPLIT_STRING) && this.dataBaseType == DataBaseType.MySql) {
                String[] ss = this.jdbcUrl.split(com.zq.simpledatax.plugin.rdbms.writer.RdbmsWriterConstant.OB10_SPLIT_STRING_PATTERN);
                if (ss.length != 3) {
