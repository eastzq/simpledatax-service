...
public class OracleReaderParser implements Parser {
	...
	public Configuration parse(DataCollectPlugin plugin) throws BusiException {
		...
		configuration.set("name", PluginEnum.ORACLE_READER.getName());
		...
		String jdbcUrl = DbHelper.getOracleJdbcUrl(reader.getDbIp(), reader.getDbPort(), reader.getDbInstanceName());
